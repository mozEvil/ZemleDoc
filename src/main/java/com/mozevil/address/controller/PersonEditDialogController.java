...
public class PersonEditDialogController {
    ...
    public void setPersonData(List<Person> personData) {
        ...
        comboBox1.getItems().addAll(personData);
        comboBox1.setPromptText("Выбрать");

        // правило отображения элементов комбобокса
        ...
        comboBox1.setButtonCell(cellFactory.call(null));
        comboBox1.setCellFactory(cellFactory);
    }
